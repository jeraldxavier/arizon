...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                // 'posts' => [
                //     'type' => \App\GraphQL\Types\PostType::class,  // Correct class reference for type
                //     'resolver' => [\App\GraphQL\Queries\PostQuery::class, 'resolve'], // Resolver method
                //     'middleware' => ['jwt.auth'], // Apply JWT middleware to this query
                // ],

                'posts' => \App\GraphQL\Queries\PostQuery::class,
                // 'posts' => [
                //     'type' => \App\GraphQL\Queries\PostQuery::class,
                //     'middleware' => ['jwt.auth'],
                // ],
            ],
            'mutation' => [
                ...
                //     'type' => \App\GraphQL\Mutations\LoginMutation::class,
                //     'middleware' => [],
                //     'route_name' => 'graphql.login',  // This should match the route name you're checking in the middleware
                // ],
            ],
            ...
            // 'middleware' => null,
            // 'middleware' => ['jwt.auth'],
            'middleware' => ['App\Http\Middleware\JwtExclusionMiddleware'],
    ...
    // 'error_formatter' => function (\Throwable $e, array $debug): array {
    ...
    //         'extensions' => $debug ? ['trace' => $e->getTrace()] : [],
    //     ];
    // },
